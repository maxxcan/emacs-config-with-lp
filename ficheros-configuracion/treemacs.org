...
La forma más rápida y fácil es usando por supuesto use-package

#+BEGIN_SRC emacs-lisp :tangle ~/.config/emacs/config/treemacs.el :noweb yes :padline no :results silent
