...
Ahora ejecutamos el demonio mpd y escribimos Alt-x: mpc 

* Juntando código
#+BEGIN_SRC emacs-lisp :tangle ~/.emacs.d/config/emms.el :noweb yes :padline no :results silent
<<emms>>
#+END_SRC
